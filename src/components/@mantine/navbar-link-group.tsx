...
const useStyles = createStyles((theme) => ({
  control: {
    ...
    display: 'block',
    width: '100%',
    padding: `calc(${theme.spacing.xs} - 4px) ${theme.spacing.md}`,
  ...
  linkParentActive: {
    '&, &:hover': {
      backgroundColor: theme.colorScheme === 'dark' ? theme.colors.blue[1] : theme.colors.blue[6],
      color: theme.colorScheme === 'dark' ? theme.colors.blue[6] : theme.colors.blue[0],
      // color: theme.fn.variant({ variant: 'light', color: theme.primaryColor }).color,
    },
  },
            ...
            <BoxLink to={link}>
              <Box
                className={cx(classes.linkParent, {
                  [classes.linkParentActive]: pathname.includes(link),
                })}
